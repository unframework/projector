...
This is a guided tour on building a view framework from scratch ([more background here](../../06/why-build-from-scratch/)). Let's get started on reinventing the wheel!
